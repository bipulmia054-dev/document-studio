  ...
  return (
    <div className="accessPage">
      <form className="accessCard" onSubmit={submit}>
        ...
        <small>DOCUMENT STUDIO • SECURE ACCESS</small>
